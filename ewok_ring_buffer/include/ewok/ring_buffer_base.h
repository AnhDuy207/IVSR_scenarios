      ...
      for (int x = 0; x < _N; x++) {
          for (int y = 0; y < _N; y++) {
              for (int z = 0; z < _N; z++) {
                    ...
                    // if (z>=30 && z<=34){
                    //     color.r = (float)255/255;
                    //     color.g = (float)160/255;
                    //     color.b = (float)122/255;
                    //     color.a = 1.0;
                    // } else {
                    //     color.r = 1;
                    //     color.g = 0;
                    ...
                    // if (z>=0 && z<=7){
                    //     color.r = (float)139/255;
                    //     color.g = 0;
                    //     color.b = 0;
                    //     color.a = 1.0;
                    // } else if (z>=8 && z<=15){
                    //     color.r = (float)178/255;
                    //     color.g = (float)34/255;
                    //     color.b = (float)34/255;
                    //     color.a = 1.0;
                    // } else if (z>=16 && z<=23){
                    //     color.r = 1;
                    //     color.g = 0;
                    ...
                    //     color.a = 1.0;
                    // } else if(z>=24 && z<=31){
                    //     color.r = (float)220/255;
                    //     color.g = (float)20/255;
                    //     color.b = (float)60/255;
                    //     color.a = 1.0;
                    // } else if(z>=32 && z<=39){
                    //     color.r = (float)205/255;
                    //     color.g = (float)92/255;
                    //     color.b = (float)92/255;
                    //     color.a = 1.0;
                    // } else if(z>=40 && z<=47){
                    //     color.r = (float)250/255;
                    //     color.g = (float)128/255;
                    //     color.b = (float)114/255;
                    //     color.a = 1.0;
                    // } else if(z>=48 && z<=55){
                    //     color.r = (float)240/255;
                    //     color.g = (float)128/255;
                    //     color.b = (float)128/255;
                    //     color.a = 1.0;
                    // } else if(z>=56 && z<=63){
                    //     color.r = (float)233/255;
                    //     color.g = (float)150/255;
                    //     color.b = (float)122/255;
                    //     color.a = 1.0;
                    // }
                    if (z>=28 && z<=30){
