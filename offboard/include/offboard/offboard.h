...
class OffboardControl
{
  ...
  private:
	...
	void inputTakeoffAndHovering(); //perform flight with current x,y and desired hovering time and altitude
	void inputTakeoffAndLandingAtMarker(); //perform flight with current x,y and desired hovering time and altitude then landing at marker
	...
	void inputMavTrajGen(); // manage input for Trajectory generation
	void mavTrajGenFlight(); //perform flight with Trajectory generation setpoints
